...
export const GetMetaData = () => {        
    return {
        "DisplayColumn": "name", //As a value, pass the Key of Dropdown data, that need displaying in the Dropdown 
        ...
        "DefaultOptionTextKey": "DefaultOptionTextKey_Text" //DefaulOptionTextKey if passed, will get the value from 
                                                         //the resource with this key and show in the Dropdown instead of DefaultOptionText.
