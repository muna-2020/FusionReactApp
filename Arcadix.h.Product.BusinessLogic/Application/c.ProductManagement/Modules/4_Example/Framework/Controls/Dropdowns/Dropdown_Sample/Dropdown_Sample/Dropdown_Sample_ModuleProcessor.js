//Helper components.
import * as Dropdown_Sample_Data from '@shared/Application/c.ProductManagement/Modules/4_Example/Framework/Controls/Dropdowns/Dropdown_Sample/Dropdown_Sample/Dropdown_Sample_Data';

/**
* @name Dropdown_Sample_ModuleProcessor
* @summary Class for Dropdown_Sample module display.
*/
class Dropdown_Sample_ModuleProcessor extends IntranetBase_ModuleProcessor {
    ...
    static GetStoreData() {
        return (objStore) => {
            return {
                ["Data"]: Dropdown_Sample_Data.GetData()                
            };
        };
    }   
