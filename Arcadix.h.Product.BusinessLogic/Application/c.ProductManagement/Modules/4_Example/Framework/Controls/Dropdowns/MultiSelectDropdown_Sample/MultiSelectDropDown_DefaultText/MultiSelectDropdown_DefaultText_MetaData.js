...
export const GetMetaData = () => {
    ...
    return {
        ...
        DependingTableName: "t_TestDrive_Subject_Data", //This props is used to check if the MultiSelectDropdown data is language dependent.
        ShortNameColumn: "vSubjectShortName", //This props is used to display the Short form of DisplayColumn.
        DefaultOptionTextKey: "DefaultOptionTextKey_Text" //DefaulOptionTextKey if passed, will get the value from the resource with this key and show in the MultiSelectDropdown instead of DefaultOptionText.
        //ShowDefaultOption: true, //when true shows the DefaultOptionText (from resource) in the MultiSelectDropdown 
