//Helper components.
import * as Dropdown_DefaultText_Sample_Data from '@shared/Application/c.ProductManagement/Modules/4_Example/Framework/Controls/Dropdowns/Dropdown_Sample/Dropdown_DefaultText_Sample/Dropdown_DefaultText_Sample_Data';

/**
* @name Dropdown_DefaultText_Sample_ModuleProcessor
* @summary Class for Dropdown_Sample module display.
*/
class Dropdown_DefaultText_Sample_ModuleProcessor extends IntranetBase_ModuleProcessor {
    ...
    static GetStoreData() {
        return (objStore) => {
            return {
                ["Data"]: Dropdown_DefaultText_Sample_Data.GetData()                
            };
        };
    }   
...
export default Dropdown_DefaultText_Sample_ModuleProcessor;