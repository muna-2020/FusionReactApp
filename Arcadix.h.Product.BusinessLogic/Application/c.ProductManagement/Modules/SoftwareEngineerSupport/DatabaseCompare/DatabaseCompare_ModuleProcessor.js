...
import ProductManagement_SoftwareEngineerSupport_DatabaseCompare from '@shared/Application/c.ProductManagement/Modules/SoftwareEngineerSupport/DatabaseCompare/DatabaseCompare_Module';

//Module related imports
import * as DatabaseCompare_Tab from '@shared/Application/c.ProductManagement/Modules/SoftwareEngineerSupport/DatabaseCompare/DatabaseCompare_Tab';
import * as DatabaseCompare_OfficeRibbon from '@shared/Application/c.ProductManagement/Modules/SoftwareEngineerSupport/DatabaseCompare/DatabaseCompare_OfficeRibbon';
...
class DatabaseCompare_ModuleProcessor extends CockpitBase_ModuleProcessor {
    ...
    GetDestinationDbConnectionStrings(objContext) {
        ProductManagement_SoftwareEngineerSupport_DatabaseCompare.GetDbConnectionStrings({}, (objReturn) => {
    ...
    GetTablesFromSchema(objContext, strType, strConnetionString) {
        ...
        ArcadixFetchData.ExecuteCustom("API/ProductManagement/SoftwareEngineerSupport/DatabaseCompare/GetTables", "POST", objParams)
            .then((objResponce) => {
    ...
    OnClickTable(objEvent, objContext, strTable) {
        ...
        ArcadixFetchData.ExecuteCustom("API/ProductManagement/SoftwareEngineerSupport/DatabaseCompare/GetProcedureForTable", "POST", objParams)
            .then((objResponce) => {
                return objResponce.json();
            }).then((objJson) => {
    ...
    OnClickProcedure(objEvent, objContext, strProcName,strId) {
        ...
        ArcadixFetchData.ExecuteCustom("API/ProductManagement/SoftwareEngineerSupport/DatabaseCompare/GetProcedureDetails", "POST", objParams)
            .then((objResponce) => {
                return objResponce.json();
            }).then((objJson) => {
                let objData = objJson["DatabaseCompare"].map((objProcs) => { return { ...objProcs, IsShowProc: false } });
    ...
    */
    GetScriptsForTables(objContext) {
        ...
        ProductManagement_SoftwareEngineerSupport_DatabaseCompare.GetScriptsForTables(objParams, (objReturn) => {
            //objContext.dispatch({ type: "SET_STATE", payload: { objDbConnectionStrings: objDbConnectionStrings } });
        });
    }
    ...
    ExecuteScript(arrScriptData, objContext) {
        ...
        ProductManagement_SoftwareEngineerSupport_DatabaseCompare.ExecuteScript(objParams, (objReturn) => {
            //objContext.dispatch({ type: "SET_STATE", payload: { objDbConnectionStrings: objDbConnectionStrings } });
        });
    }
    ...
    //    };
    //    ProductManagement_SoftwareEngineerSupport_DatabaseCompare.GetNewProcedures(objParams, (objReturn) => {
    //        //objContext.dispatch({ type: "SET_STATE", payload: { objDbConnectionStrings: objDbConnectionStrings } });
    //    });
    //}
    ...
    GetProcedures(strDbConnectionString, strDbType, objContext) {
        ...
        ProductManagement_SoftwareEngineerSupport_DatabaseCompare.GetProcedures(objParams, (objReturn) => {
    ...
    GetEditedProcedures(objContext) {
        ...
        ProductManagement_SoftwareEngineerSupport_DatabaseCompare.GetEditedProcedures(objParams, (objReturn) => {
    ...
    SetTabData() {
        var objTabData = {
            TabData: DatabaseCompare_Tab.GetTabData()
        };
        ApplicationState.SetProperty("ModuleTabData", { "DatabaseCompare": objTabData });
    }
