//Base class imports
import TeacherNews_ModuleProcessor_Browser from "@shared/Application/d.Extranet/3_Teacher/PC/Modules/TeacherStartPage/TeacherStartPage_ModuleProcessor";
...
/**
* @name TeacherStartPage_ModuleProcessor
* @summary Class for TeacherStartPage module display and manipulate.
*/
class TeacherStartPage_ModuleProcessor extends TeacherNews_ModuleProcessor_Browser {
    ...
    */
    GetDynamicStyles(props) {
        return [
            props.JConfiguration.ExtranetSkinPath + "/Css/Application/3_Teacher/ReactJs/Phone/Modules/TeacherStartPage/TeacherStartPage.css",
    ...
    //         ]
    //     };
    //     Object_TestApplication_TestLoginAndResult.Initialize([objOrientationTestLoginAndResultParams, objHighStakeTestLoginAndResultParams, objLearningExtranetTestResultParams]);
    ...
    //     let strClassId = ApplicationState.GetProperty("SelectedClassId");
    //     let arrTempPupilData = DataRef(objContext.props.Object_Extranet_Pupil_Pupil, "Object_Extranet_Pupil_Pupil;t_TestDrive_Member_Class_Pupil.uClassId;" + strClassId)["Data"];
