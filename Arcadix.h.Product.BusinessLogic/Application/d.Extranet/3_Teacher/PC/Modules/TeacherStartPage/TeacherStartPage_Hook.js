...
export function GetInitialState(props) {
    ...
    if (
        ...
        DataRef(props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strOrientationCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
        DataRef(props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strHighStakeCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
        DataRef(props.Object_TestApplication_LearningTestLoginAndResult, "Object_TestApplication_LearningTestLoginAndResult;iCycleTypeId;" + strLearningCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
        ...
        let arrOrientationTestLoginResult = DataRef(props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strOrientationCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
        let arrHighStakeTestLoginResult = DataRef(props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strHighStakeCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
        ...
        let arrLearningTestLoginResult = DataRef(props.Object_TestApplication_LearningTestLoginAndResult, "Object_TestApplication_LearningTestLoginAndResult;iCycleTypeId;" + strLearningCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
...
export function useDataLoaded(objContext) {
    ...
    useEffect(() => {
        ...
        if (DataRef(objContext.props.Object_Extranet_Teacher_Class, "Object_Extranet_Teacher_Class;t_TestDrive_Member_Class_Teacher.uTeacherId;" + objContext.props.ClientUserDetails.UserId)["Data"] &&
            ...
            DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strOrientationCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
            DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strHighStakeCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
            DataRef(objContext.props.Object_TestApplication_LearningTestLoginAndResult, "Object_TestApplication_LearningTestLoginAndResult;iCycleTypeId;" + strLearningCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"] &&
            ...
            let arrOrientationTestLoginResult = DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strOrientationCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
            let arrHighStakeTestLoginResult = DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strHighStakeCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
            ...
            let arrLearningTestLoginResult = DataRef(objContext.props.Object_TestApplication_LearningTestLoginAndResult, "Object_TestApplication_LearningTestLoginAndResult;iCycleTypeId;" + strLearningCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId)["Data"];
...
export function useDataLoadedAfterClassChange(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            ...
            let uSchoolId = objContext.props.ClientUserDetails.TeacherDetails["t_TestDrive_Member_Teacher_School"][0]["uSchoolId"];
            let strTeacherId = objContext.props.ClientUserDetails.UserId;
            if (DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strOrientationCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId) &&
                DataRef(objContext.props.Object_TestApplication_TestLoginAndResult, "Object_TestApplication_TestLoginAndResult;iCycleTypeId;" + strHighStakeCycleTypeId + ";uClassId;" + strClassId + ";iStateId;" + iStateId) &&
