...
export function GetInitialState(props) {
    ...
    if (
        ...
        && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/7_Report/Essay/EssayBilling", props)
...
export function useDataLoader(objContext) {
    useLayoutEffect(() => {
        objContext.EssayBilling_ModuleProcessor.LoadInitialData(objContext);
    }, []);
}
...
export function useDataLoaded(objContext) {
    useEffect(() => {
        ...
        if (!objContext.state.isLoadComplete
            ...
            && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/7_Report/Essay/EssayBilling", objContext.props)
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            objContext.EssayBilling_ModuleProcessor.SetRibbonData(objContext);
        }
    }, [objContext.state]);
