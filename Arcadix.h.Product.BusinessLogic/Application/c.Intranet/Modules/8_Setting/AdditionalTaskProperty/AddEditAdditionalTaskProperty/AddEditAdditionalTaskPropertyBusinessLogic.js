...
export function useInitializeRibbon(objContext) {
    ...
    useEffect(() => {
        ApplicationState.SetProperty("PopupTabData", { "addeditadditonaltaskproperty": arrTabData });
        ApplicationState.SetProperty("PopupRibbonData", { "addeditadditonaltaskproperty": arrRibbonData });
    }, [objContext.state]);
}
...
export function useInitializeTabs(objContext) {
    ...
    useEffect(() => {
        ApplicationState.SetProperty("PopupNavigationData", { "addeditadditonaltaskproperty": arrContentData });
    },
        [])
}
...
export function useInitializeData(objContext) {
    ...
    var objAddData = {        
        "cIsAnswerMandatory": null,        
        "cIsDeleted": "N",        
        "dtCreatedOn": null,
        "dtModifiedOn":null,
        "iAdditionalTaskPropertyId": null,        
        "iMainClientId": objContext.props.Data.JConfiguration.MainClientId, //97,
        "iOrderId": null,
        "t_TestDrive_Task_AdditionalTaskProperty_Data":GetMultiLanguageData(objContext)["arrMultiLanguageData"],        
        ...
        if (objContext.props.Data.blnIsAdd && !objContext.state.blnAddedOnce) {
           ...
           // console.log("///",objAdditionalPropertyParams)
            ...
            if (objContext.state.blnAddedOnce) {
                ...
                objEditData["iAdditionalTaskPropertyId"] = objContext.state.objAdditionalProperty["iAdditionalTaskPropertyId"];
            }
            let objAdditionalPropertyParams = {               
                "vEditData": objContext.state.blnAddedOnce ? objEditData : objContext.state.objData,
                "uUserId": objContext.props.Data.ClientUserDetails.UserId
            };
            console.log("objAdditionalPropertyParams",objAdditionalPropertyParams);
            arrParams = [...arrParams,
            {
                "URL": "API/Object/Intranet/TaskAdditionalProperty",
                "Params": objAdditionalPropertyParams,
...
export function ModifyEditData(objContext, arrSelectedRows, objTempEditData) {
    ...
    if (objContext.props.Data.blnIsEdit && arrSelectedRows) {
        ...
        arrMultiLanguageData.map((objMultiLanguageData) => {
            let arrTempSubjectData = objTempEditData["t_TestDrive_Task_AdditionalTaskProperty_Data"].filter((objTableData) => objTableData["iLanguageId"].toString() === objMultiLanguageData["iLanguageId"].toString())
        ...
        objNewEditData = { ...objTempEditData, "t_TestDrive_Task_AdditionalTaskProperty_Data": arrSubjectData }
    }
