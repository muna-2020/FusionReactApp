...
import * as CurrentExceptions_MetaData from '@shared/Application/c.Intranet/Modules/8_Setting/LogsAndException/Exceptions/CurrentExceptions/CurrentExceptions_MetaData';
import * as CurrentExceptions_OfficeRibbon from '@shared/Application/c.Intranet/Modules/8_Setting/LogsAndException/Exceptions/CurrentExceptions/CurrentExceptions_OfficeRibbon';

/**
 * @name CurrentExceptions_ModuleProcessor
 * @param NA
 * @summary Class for CurrentExceptions module display.
 * @return NA
 */
class CurrentExceptions_ModuleProcessor extends IntranetBase_ModuleProcessor {
    ...
    static StoreMapList() {
        return [
            "Object_Framework_Services_TextResource;Id;" + JConfiguration.LanguageCultureInfo + "/c.Intranet/Modules/8_Setting/LogsAndException/Exceptions/CurrentExceptions",
    ...
    InitialDataParams(props) {
        ...
        // Text Resource
        let arrResourceParams = ["/c.Intranet/Modules/8_Setting/LogsAndException/Exceptions/CurrentExceptions"];
     ...
     * @summary Loads the Exception data from Redis
     */
    LoadExceptionData(objContext) {
    ...
    GetMetaData(objContext) {
        return {
            ...CurrentExceptions_MetaData.GetMetaData()
        };
    }
   ...
   */
    GetResourceData(objContext) {
        let Text = Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/8_Setting/LogsAndException/Exceptions/CurrentExceptions", objContext.props) ?? {}
  ...
  */
    ...
    SetRibbonData(objContext) {
        var objRibbonData = {
            objContext,
            "ExportToExcel": () => objContext.CurrentExceptions_ModuleProcessor.ExportToExcel(objContext)
        };
        ApplicationState.SetProperty("OfficeRibbonData", CurrentExceptions_OfficeRibbon.GetOfficeRibbonData(objRibbonData));
    }
...
export default CurrentExceptions_ModuleProcessor;