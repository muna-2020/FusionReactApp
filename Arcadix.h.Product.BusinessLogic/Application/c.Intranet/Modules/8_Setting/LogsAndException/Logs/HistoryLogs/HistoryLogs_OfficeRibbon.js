...
export function GetOfficeRibbonData(objData) {
    ...
    var objTextResource = Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/8_Setting/LogsAndException/Logs/HistoryLogs", objData.objContext.props);
    let arrRibbonData = [
        {
            Text: Localization.TextFormatter(objTextResource, "DbDataLogs"),
            ToolBarData: [
                {//Group1
