...
* @returns {array} array
*/
export function GetSchoolYearOfficeRibbonData(objData) {
    var objTextResource = Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/8_Setting/SchoolYear", objData.objContext.props) ?? {};
    return (
        [
            {
                Text: Localization.TextFormatter(objTextResource, "SchoolYear"),
                ToolBarData: [
                    {
