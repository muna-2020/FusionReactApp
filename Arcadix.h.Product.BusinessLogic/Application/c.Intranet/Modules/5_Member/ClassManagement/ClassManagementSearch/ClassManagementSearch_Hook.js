...
export function GetInitialState() {
    return {
        ...
        arrSchoolData: [],
        arrTeacherData: [],
        objSearchFilters: { "iStateId": -1, "cIsDeleted": "N", "uSchoolId": -1, "cIsTestSchool": "N", "cIsStellwerk":"N" },
    };
}
...
export function useLoadTheSelecedSateSchools(objContext) {
    useEffect(() => {
        if (objContext.state.strStateId != -1) {
            objContext.ClassManagementSearch_ModuleProcessor.LoadSelectedStateSchools(objContext, objContext.state.strStateId);
        }
