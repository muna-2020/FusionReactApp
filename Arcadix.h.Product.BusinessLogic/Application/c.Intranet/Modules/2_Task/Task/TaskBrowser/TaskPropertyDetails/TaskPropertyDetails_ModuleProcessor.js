...
/**
* @name TaskPropertyDetails_ModuleProcessor
* @summary Class for Task module display.
*/
class TaskPropertyDetails_ModuleProcessor extends IntranetBase_ModuleProcessor {
    ...
    InitialDataParams(props) {
        ...
        //WorkflowStatus
        Object_Cockpit_Workflow_WorkflowStatus.Initialize({});
    ...
    GetTaskDetails(objSelectedRow, objContext) {
        ...
        try {
            ...
            if (objSelectedRow.t_CMS_Page_AssignedWorkflowStatus && objSelectedRow.t_CMS_Page_AssignedWorkflowStatus?.length > 0) {
                let objLatestWorkFlowStatus = objSelectedRow.t_CMS_Page_AssignedWorkflowStatus?.find(objAssignedWorkflowStatus => objAssignedWorkflowStatus["cIsLatest"] == "Y" && objAssignedWorkflowStatus["iLanguageId"] == JConfiguration.InterfaceLanguageId);
...
export default TaskPropertyDetails_ModuleProcessor;