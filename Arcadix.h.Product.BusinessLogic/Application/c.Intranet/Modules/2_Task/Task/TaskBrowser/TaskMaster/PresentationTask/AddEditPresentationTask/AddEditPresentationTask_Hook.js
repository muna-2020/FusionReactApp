...
import * as AddEditPresentationTask_OfficeRibbon from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/PresentationTask/AddEditPresentationTask/AddEditPresentationTask_OfficeRibbon';
import * as AddEditPresentationTask_Tab from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/PresentationTask/AddEditPresentationTask/AddEditPresentationTask_Tab';
...
export function GetInitialState(props) {
    ...
    return {
        objData: props.Data.IsEdit ? props.Data.objSelectedRow : AddEditPresentationTask_ModuleProcessor.GetInitialData(props),
...
export function Initialize(objContext) {
    ...
    Base_AddEditTaskMaster_Hook.useDataLoader(objContext.AddEditPresentationTask_ModuleProcessor, objContext);
...
export function useInitializeTabData(objContext) {
    useEffect(() => {
        ...
        var arrContentData = AddEditPresentationTask_Tab.GetAddEditPresentationTaskTab(objContext, objData);
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        var objData = {
            objContext,
            "SaveMethod": () => objContext.AddEditPresentationTask_ModuleProcessor.SaveData(objContext),
            "SaveAndCloseMethod": () => objContext.AddEditPresentationTask_ModuleProcessor.SaveData(objContext, true)
        };
        let objRibbonData = AddEditPresentationTask_OfficeRibbon.GetAddEditPresentationTaskOfficeRibbonData(objData);
