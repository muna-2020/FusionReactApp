...
/**
 * @name GetAddEditHighStakeAdaptiveTaskTab
 * @param {object} objContext takes objContext
 * @param {object} objData takes objData
 * @summary Setting up Content Data
 * @returns {array} arrContentData
 */
export function GetAddEditHighStakeAdaptiveTaskTab(objContext, objData) {
    ...
    let arrContentData = [
        {
            ...
            "Children": [
                ...
                {
                    "Text": Localization.TextFormatter(objTextResource, "EmpiricalData"),
                    "Id": "EmpiricalDataDiv",
                    "Event": () => { objData.ShowDiv("EmpiricalDataDiv"); }
                }
            ]
        },
        {
