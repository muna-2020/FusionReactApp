...
export function GetInitialState(props) {
    ...
    if (
        ...
        && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/AdditionalPropertyValue", props)
    ...
    return {
        ...
        strAdditionalTaskPropertyId: -1,
        strDependencyColumnValueId: null,
...
export function useDataLoader(objContext) {
    useLayoutEffect(() => {
        objContext.AdditionalPropertyValue_ModuleProcessor.LoadInitialData(objContext);
    }, []);
}
...
export function useDataLoaded(objContext) {
    useEffect(() => {
        ...
        if (!objContext.state.isLoadComplete
            ...
            && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/AdditionalPropertyValue", objContext.props)
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            objContext.AdditionalPropertyValue_ModuleProcessor.SetRibbonData(objContext);
        }
    }, [objContext.state]);
