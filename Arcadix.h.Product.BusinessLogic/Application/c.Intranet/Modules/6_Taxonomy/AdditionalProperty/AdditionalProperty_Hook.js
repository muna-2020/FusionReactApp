...
export function GetInitialState(props) {
    ...
    if (
        ...
        && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/AdditionalProperty", props)
    ...
    return {
        ...
        iAdditionalPropertyDependencyId: -1,
    };
}
...
export function useDataLoader(objContext) {
    useLayoutEffect(() => {
        objContext.AdditionalProperty_ModuleProcessor.LoadInitialData(objContext);
    }, []);
}
...
export function useDataLoaded(objContext) {
    useEffect(() => {
        ...
        if (!objContext.state.isLoadComplete
            ...
            && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/AdditionalProperty", objContext.props)
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            objContext.AdditionalProperty_ModuleProcessor.SetRibbonData(objContext);
        }
    }, [objContext.state]);
