...
export function mapStateToProps(state) {
    if (!global["mode"]) {
        return {
            category: DataRef(state.Entity, "object_intranet_taxonomy_competencyrange", true)
        };
    }
    else {
...
export function useInitializeRibbon(objContext) {
    ...
    useEffect(() => {
        ApplicationState.SetProperty("PopupTabData", { "addeditcompetencyrange": arrTabData });
        ApplicationState.SetProperty("PopupRibbonData", { "addeditcompetencyrange": arrRibbonData });
    }, [objContext.state]);
}
...
export function useInitializeTabs(objContext) {
    ...
    useEffect(() => {
        ApplicationState.SetProperty("PopupNavigationData", { "addeditcompetencyrange": arrContentData });
    },
        []);
}
...
export function useInitializeData(objContext) {
    ...
    var objAddData = {
        ...
        "cIspreselect": "N",
        "uUserId": null,
        "t_testdrive_Category_Competency_CompetencyRange_Data": GetMultiLanguageData(objContext)["arrMultiLanguageData"]
    };
...
export function ModifyEditData(objContext, arrSelectedRows, objTempEditData) {
    ...
    if (objContext.props.Data.blnIsEdit && arrSelectedRows) {
        ...
        arrMultiLanguageData.map((objMultiLanguageData) => {
            let arrTempSubjectData = objTempEditData["t_testdrive_Category_Competency_CompetencyRange_Data"].filter((objTableData) => objTableData["iLanguageId"].toString() === objMultiLanguageData["iLanguageId"].toString());
        ...
        objNewEditData = { ...objTempEditData, "t_testdrive_Category_Competency_CompetencyRange_Data": arrSubjectData };
    }
    ...
    if (blnIsValid) {
        ...
        if (objContext.props.Data.blnIsAdd && !objContext.state.blnAddedOnce) {
            ...
            if (objContext.state.blnAddedOnce) {
                ...
                objEditData["iCompetencyRangeId"] = objContext.state.objCompetencyRange["iCompetencyRangeId"];
            }
            let objCompetencyRangeParams = {
