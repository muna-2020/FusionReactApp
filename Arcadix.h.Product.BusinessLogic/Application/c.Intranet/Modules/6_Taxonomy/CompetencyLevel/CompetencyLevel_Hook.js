...
export function GetInitialState(props) {
    ...
    if (
        ...
        && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/CompetencyLevel", props)
...
export function useDataLoader(objContext) {
    useLayoutEffect(() => {
        objContext.CompetencyLevel_ModuleProcessor.LoadInitialData(objContext);
    }, []);
}
...
export function useDataLoaded(objContext) {
    useEffect(() => {
        ...
        if (!objContext.state.isLoadComplete
            ...
            && Object_Framework_Services_TextResource.GetData("/c.Intranet/Modules/6_Taxonomy/CompetencyLevel", objContext.props)
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            objContext.CompetencyLevel_ModuleProcessor.SetRibbonData(objContext);
        }
    }, [objContext.state]);
