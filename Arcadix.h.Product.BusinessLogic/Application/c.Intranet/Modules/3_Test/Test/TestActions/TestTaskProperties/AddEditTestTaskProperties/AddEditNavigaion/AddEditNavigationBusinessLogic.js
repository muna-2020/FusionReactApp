...
export function useInitializeRibbon(objContext) {
    ...
    useEffect(() => {
        ...
        ApplicationState.SetProperty("PopupTabData", { ...objOldPopupTabData, "addeditnavigation_popup": arrTabData });
        ApplicationState.SetProperty("PopupRibbonData", { ...objOldPopupRibbonData, "addeditnavigation_popup": arrRibbonData });
    }, [objContext.state]);
}
...
export function useInitializeTabs(objContext) {
    let arrContentData = [
        {//Group1
            "Text": objContext.props.Data.objTextResource["Navigation"],
            "Id": "Navigation",
            "Children": [
                {
                    "Text": objContext.props.Data.objTextResource["Navigation"],
    ...
    useEffect(() => {
        ...
        ApplicationState.SetProperty("PopupNavigationData", { ...objOldPopupNavigationData, "addeditnavigation_popup": arrContentData });
    },
        [])
}
