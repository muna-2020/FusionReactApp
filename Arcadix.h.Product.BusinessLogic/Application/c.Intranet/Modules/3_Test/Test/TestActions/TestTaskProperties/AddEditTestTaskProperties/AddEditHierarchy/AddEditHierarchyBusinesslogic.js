...
export function useInitializeRibbon(objContext) {
    ...
    useEffect(() => {
        ...
        ApplicationState.SetProperty("PopupTabData", { ...objOldPopupTabData, "addedithierarchy_popup": arrTabData });
        ApplicationState.SetProperty("PopupRibbonData", { ...objOldPopupRibbonData, "addedithierarchy_popup": arrRibbonData });
    }, [objContext.state]);
}
...
export function useInitializeTabs(objContext) {
    let arrContentData = [
        {//Group1
            "Text": objContext.props.Data.objTextResource["Hierarchy"],
            "Id": "Hierarchy",
            "Children": [
                {
                    "Text": objContext.props.Data.objTextResource["Hierarchy"],
    ...
    useEffect(() => {
        ...
        ApplicationState.SetProperty("PopupNavigationData", { ...objOldPopupNavigationData, "addedithierarchy_popup": arrContentData });
    },
        [])
}
...
*/
export function HandleChange(strId, strValue, objContext, blnChecked) {
    var objNewData = {};
    objNewData = { ...objContext.state.objData, [strId]: blnChecked == true ? "Y" :"N" };
