...
/**
* @name Cokpit_LoginAndMaster_Login
* @summary Mopdule object for ProductManagement login.
* @returns {object} Json with required Methods
*/
var Cokpit_LoginAndMaster_Login = {
    URL: "API/Cockpit/LoginAndMaster/Login",
    ...
    */
    ValidateUser: (objParams, fnCallback) => {
        ...
        let objRequestParams = {
            URL: Cokpit_LoginAndMaster_Login.URL + "/ValidateUser",
            Params: objParams
        };
        ArcadixFetchData.ExecuteCustom(Cokpit_LoginAndMaster_Login.URL + "/ValidateUser", "POST", objRequestParams, objCustomHeaders)
            .then(objResponse => {
...
export default Cokpit_LoginAndMaster_Login;
