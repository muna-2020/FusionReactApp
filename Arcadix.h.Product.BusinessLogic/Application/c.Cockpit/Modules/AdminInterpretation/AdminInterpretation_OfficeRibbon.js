...
/**
 * @name GetAdminInterpretationOfficeRibbonData
 * @param {object} objData takes  objData
 * @summary Get data to initialize RibbonData
 * @returns {array} array
 */
export function GetAdminInterpretationOfficeRibbonData(objData) {
    var objTextResource = Object_Framework_Services_TextResource.GetData("/c.Cockpit/Modules/AdminInterpretation", objData.objContext.props) ?? {};

    return (
        [
            {
                Text: Localization.TextFormatter(objTextResource, "AdminInterpretation"),
                ToolBarData: [
                    {
