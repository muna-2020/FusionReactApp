...
export function GetInitialState(props) {
    ...
    if (
        ...
        && Object_Framework_Services_TextResource.GetData("/c.Cockpit/Modules/MainClient/Country", props)
...
export function useDataLoader(objContext) {
    useLayoutEffect(() => {
        objContext.Country_ModuleProcessor.LoadInitialData(objContext);
    }, []);
}
...
export function useDataLoaded(objContext) {
    useEffect(() => {
        ...
        if (!objContext.state.isLoadComplete
            ...
            && Object_Framework_Services_TextResource.GetData("/c.Cockpit/Modules/MainClient/Country", objContext.props) 
...
export function useSetRibbonData(objContext) {
    useEffect(() => {
        if (objContext.state.isLoadComplete) {
            objContext.Country_ModuleProcessor.SetRibbonData(objContext);
        }
    }, [objContext.state]);
