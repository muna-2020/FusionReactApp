...
function useImperativeMethods(objContext) {
    ...
    useImperativeHandle(objContext.props.ElementRef, () => ({
        ...
        "GetContextMenuOptions": (intElementTextId) => {
            ...
            return objContext.CMSRadio_Editor_ModuleProcessor.GetContextMenuOptions(objContext, { "Value": arrData[0], "Type": strType });
        },
        "GetPointOverride": () => {
            return objContext.CMSRadio_Editor_ModuleProcessor.GetPointOverride(objContext);
        },
        "SetPointOverride": (objPoints) => {
            objContext.CMSRadio_Editor_ModuleProcessor.SetPointOverride(objContext, objPoints);
        },
        "RemovePointOverride": () => {
            objContext.CMSRadio_Editor_ModuleProcessor.RemovePointOverride(objContext);
        },
