...
/**
 * @name ImageProperties_ModuleProcessor
 * @summary Contains the ImageSidebar's editor version module specific methods.
 * */
class ImageProperties_ModuleProcessor extends EditorBase_ModuleProcessor {
     ...
     */
    static StoreMapList() {
        return ["Object_Framework_Services_TextResource;Id;" + JConfiguration.LanguageCultureInfo + "/e.Editor/Modules/6_CMSElement/CMSImage/ImageProperties"];
    }
    ...
    LoadInitialData(objContext) {
        (new ObjectQueue()).QueueAndExecute(objContext.ImageProperties_ModuleProcessor.InitialDataParams(objContext.props));
    }
    ...
    InitialDataParams(props) {
        let arrResourceParams = ["/e.Editor/Modules/6_CMSElement/CMSImage/ImageProperties"];
    ...
    GetDynamicStyles(props) {
        return [props.JConfiguration.EditorSkinPath + "/Css/Application/ReactJs/PC/Modules/6_CMSElement/CMSImage/ImageProperties/ImageProperties.css"]
    };
}

export default ImageProperties_ModuleProcessor;
