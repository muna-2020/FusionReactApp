...
/**
 * @name CMSRadioMatrix_Editor_ContextMenu
 * @summary Contains the context menu related methods of the CMSRadioMatrix
 */
class CMSRadioMatrix_Editor_ContextMenu extends ContextMenuBase_ModuleProcessor {

    /**
     * @name GetContextMenuOptions
     * @param {object} objContext {state, props, dispatch, CMSRadioMatrix_Editor_ModuleProcessor}
     * @param {object} objParams { "Value": CMSRadioMatrix Value, "Type": ROW/COLUMN/ROW_HEADER/ELEMENT_HEADER }
     * @summary Forms an array with the ContextMenuOptions for the CMSRadioMatrix element.
    ...
    GetContextMenuOptions(objContext, objParams) {
                ...
                arrContextMenuOptions = [
                    {
                        ...
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.InsertRowAbove,
                        params: { objContext, "objValue": Value }
                    },
                    {
                        ResourceKey: "Insert_Below",
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.InsertRowBelow,
                        params: { objContext, "objValue": Value }
                    },
                    {
                        ResourceKey: "Remove_Row",
                        Disable: objContext.state.ElementJson["vElementJson"]["MatrixRow"].length > 1 ? false : true,
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.DeleteRow,
                        params: { objContext, "objValue": Value }
                    },
                    {
                        Type: "Separator"
                    ...
                    {
                        ResourceKey: "Move_Up",
                        Disable: objContext.state.ElementJson["vElementJson"]["MatrixRow"].findIndex(objMatrixRow => objMatrixRow["iElementRadioMatrixRowId"] === Value["iElementRadioMatrixRowId"]) > 0 ? false : true,
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.MoveRowUp,
                        params: { objContext, "objValue": Value }
                    },
                    {
                        ResourceKey: "Move_Down",
                        Disable: objContext.state.ElementJson["vElementJson"]["MatrixRow"].findIndex(objMatrixRow => objMatrixRow["iElementRadioMatrixRowId"] === Value["iElementRadioMatrixRowId"]) < objContext.state.ElementJson["vElementJson"]["MatrixRow"].length - 1 ? false : true,
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.MoveRowDown,
                        params: { objContext, "objValue": Value }
                    },
                    {
                        Type: "Separator"
                    },
                    {
                        ...
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.RandomDisplay,
                    ...
                    },
                    {
                        ...
                        ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.AlignValue,
                    ...
                    arrContextMenuOptions = [
                        {
                            ...
                            ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.InsertColumnLeft,
                            params: { objContext, "objValue": Value }
                        },
                        {
                            ResourceKey: "Insert_Right",
                            ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.InsertColumnRight,
                            params: { objContext, "objValue": Value }
                        },
                        {
                            ResourceKey: "Remove_Column",
                            Disable: objContext.state.ElementJson["vElementJson"]["MatrixColumn"].length > 2 ? false : true,
                            ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.DeleteColumn,
                            params: { objContext, "objValue": Value }
                        },
                        {
                            Type: "Separator"
                        },
                        {
                            ...
                            Disable: objContext.state.ElementJson["vElementJson"]["MatrixColumn"].findIndex(objColumn => objColumn["iElementRadioMatrixColumnId"] === Value["iElementRadioMatrixColumnId"]) > 0 ? false : true,
                            ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.MoveColumnLeft,
                            params: { objContext, "objValue": Value }
                        },
                        {
                            ResourceKey: "Move_Right",
                            Disable: objContext.state.ElementJson["vElementJson"]["MatrixColumn"].findIndex(objColumn => objColumn["iElementRadioMatrixColumnId"] === Value["iElementRadioMatrixColumnId"]) < objContext.state.ElementJson["vElementJson"]["MatrixColumn"].length - 1 ? false : true,
                            ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.MoveColumnRight,
                            params: { objContext, "objValue": Value }
                        },
                        {
                            Type: "Separator"
        ...
        arrContextMenuOptions = [
            ...arrContextMenuOptions,
            {
                ...
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.ChangeOrientationOfRowHeader,
                params: { objContext },
                Image: objContext.state.ElementJson["vElementJson"]["cIsTitleToLeft"] === "Y" ? "/Images/editor/Icon_Yes.gif" : "/Images/editor/Icon_No.gif"
            },
            {
                ResourceKey: "Show_True_False",
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.TrueFalse,
                params: { objContext },
                Image: objContext.state.ElementJson["vElementJson"]["cIsTrueFlase"] === "Y" ? "/Images/editor/Icon_Yes.gif" : "/Images/editor/Icon_No.gif"
            },
            {
                ResourceKey: "LoadLikert",
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.LoadLikert,
                params: { objContext },
            ...
            },
            {
                ...
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.SetHeaderFooterAsTitle,
                params: { objContext },
            ...
            },
            {
                ...
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.LookAndFeel,
                params: { objContext }
            },
        ];
        if (blnIsPointOverride) {
            arrContextMenuOptions = [
                ...arrContextMenuOptions,
                {
                    ...
                    ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.ShowPointOverrideSidebar,
                    params: { objContext },
        ...
        arrContextMenuOptions = [
            ...
            },
            {
                ...
                ClickEvent: objContext.CMSRadioMatrix_Editor_ModuleProcessor.ShowHeaderText,
                params: { objContext },
        ...
        return [
            {
                Module: "CMSRadioMatrix",
                MenuList: arrContextMenuOptions,
                Visible: true,
                ResourcePath: "/e.Editor/Modules/6_CMSElement/CMSRadioMatrix"
            },
    ...
    OpenContextMenu(objContext, intClientX, intClientY, objParams) {
        objContext.CMSRadioMatrix_Editor_ModuleProcessor.ShowContextMenu({
            objContext,
            objClientXY: { clientX: intClientX, clientY: intClientY },
            arrContextMenuDetail: objContext.CMSRadioMatrix_Editor_ModuleProcessor.GetContextMenuOptions(objContext, objParams)
        });
    }
}

export default CMSRadioMatrix_Editor_ContextMenu;
