...
export const GetData = () => {
    ...
    return {
        //RowData: arrRowData,//The data has all the fields corresponding to the Header (meta data) keys. It is a mandatory props
        LanguageData,//Will hold the information of the different language that the client uses. It is a mandatory prop only for DispalyGrid.
        DropDownData, //Is an object that has the fields corresponding to the metadata fields with vControlType as dropdown. It is not a mandatory props.
    };
};
