...
(function (DragDropTouch_1) {
    ...
    var DragDropTouch = (function () {
        ...
        function DragDropTouch() {
            ...
            if ('ontouchstart' in document || 'ontouchstart' in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0) {
        ...
        DragDropTouch.prototype._moveImage = function (e) {
            ...
            requestAnimationFrame(function () {
                var pt = _this._getPoint(e, true), s = _this._img && _this._img.style ? _this._img.style: {};
                s.position = 'absolute';
