	...
	$.widget("thomaskahn.smoothDivScroll", {
		...
		_create: function () {
			...
			*****************************************/
			...
			el.data("scrollingHotSpotRight").bind("click", function (e) {
			...
			el.data("scrollingHotSpotRight").bind("click", function () {
				if (o.hotSpotScrolling) {
				    ...
				    //el.data("rightScrollingInterval", setInterval(function () {}, o.hotSpotScrollingInterval));
			...
			*****************************************/
			...
			el.data("scrollingHotSpotLeft").bind("click", function (e) {
				if (o.hotSpotScrolling) {
			...
			el.data("scrollingHotSpotLeft").bind("click", function () {
			    if (o.hotSpotScrolling) {			    
					...
					//el.data("leftScrollingInterval", setInterval(function () { }, o.hotSpotScrollingInterval));
		...
		**********************************************************/		
		recalculateScrollableArea: function () {
			...
			el.data("scrollableArea").find(o.countOnlyClass).each(function () {
			...
			if (tempScrollableAreaWidth == 0)
			    tempScrollableAreaWidth = screen.innerWidth;
                        else
			    tempScrollableAreaWidth = tempScrollableAreaWidth + 5;//increase width by 5px , some times there will be slight error in getting correct width while  looping
