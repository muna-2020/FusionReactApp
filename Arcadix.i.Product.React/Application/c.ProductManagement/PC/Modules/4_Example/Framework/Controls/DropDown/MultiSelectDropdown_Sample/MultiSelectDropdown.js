...
import MultiSelectDropDown_Sample_ModuleProcessor from '@shared/Application/c.ProductManagement/Modules/4_Example/Framework/Controls/Dropdowns/MultiSelectDropDown_Sample/MultiSelectDropDown_Sample_ModuleProcessor';
import * as MultiSelectDropDown_Sample_Hook from '@shared/Application/c.ProductManagement/Modules/4_Example/Framework/Controls/Dropdowns/MultiSelectDropDown_Sample/MultiSelectDropDown_Sample_Hook';
    ...
    return (
        <React.Fragment>
            <MultiSelectDropDown
                ...
                Events={objContext.MultiSelectDropDown_Sample_ModuleProcessor.GetEvents(objContext)}
                CallBacks={() => { }}
                ParentProps={{ ...props }}
            />
        </React.Fragment>
