...
const ContextMenu_Sample = props => {
    ...
    var arrContextListSample = [
        {
            ...
            Id: 1,
            Text: "1",
            "Image":"/Images/Framework/ReactJs/PC/Controls/Tree/folder_brown.png",
            ClickEvent: () => alert("1")
        },
        {
            ParentId: 0,
    ...
    function OnRowRightClick(objEvt, strSelectedRow) {
        let objContextMenu = {
            ...
            objEvent: { clientX: objEvt.clientX, clientY: objEvt.clientY }
        };
    ...
    let jsx = (<ul>
        <li onContextMenu={(e) => { OnRowRightClick(e, "Test1"); }} >
            Test1
                </li>
        <li onContextMenu={(e) => { OnRowRightClick(e, "Test2"); }}>
            Test2
                </li>
        <li onContextMenu={(e) => { OnRowRightClick(e, "Test3"); }}>
            Test3
                </li>
    </ul>);
    return jsx;
