...
const OfficeRibbonContainer = props => {
    ...
    return <div className="top-navigation">
        <MasterOfficeRibbon SkinPath={props.JConfiguration.ExtranetSkinPath} JConfiguration={props.JConfiguration} ComponentController ={ComponentController} isSSRDisabled={false}/>
    </div>
}
