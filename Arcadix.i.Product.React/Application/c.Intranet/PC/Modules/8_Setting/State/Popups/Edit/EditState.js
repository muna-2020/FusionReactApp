...
const EditAdministrators = props => {
    ...
    console.log("arrSelectedRows ", arrSelectedRows)
            ...
            {arrSelectedRows.length === 0 ? <div>Please select a line before continuing</div>:
                <React.Fragment>
                    <div style={{ display: "flex" }}>
                        <span style={{ marginRight: "10px" }}>{props.Data.objTextResource['PopUpStateId']} :</span>
                    ...
                    <div style={{ display: "flex" }}>
                        <span style={{ marginRight: "10px" }}>{props.Data.objTextResource['PopUpFirstName']} :</span>
                    ...
                    <div style={{ display: "flex" }}>
                        <span style={{ marginRight: "10px" }}>{props.Data.objTextResource['PopUpName']} :</span>
