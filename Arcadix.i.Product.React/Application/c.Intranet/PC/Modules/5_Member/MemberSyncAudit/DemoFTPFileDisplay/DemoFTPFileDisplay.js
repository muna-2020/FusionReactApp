...
var DemoFtpFileDetails = /** @class */ (function (_super) {
    __extends(DemoFtpFileDetails, _super);
    function DemoFtpFileDetails(props, context) {
    ...
    DemoFtpFileDetails.InitialDataParams = function (JConfiguration, objParams) {
        var arrDataRequest = [];
    ...
    DemoFtpFileDetails.prototype.componentDidMount = function () {
        this.setState({ blnShowAnimation: true });
        var objArcadixFetchAndCacheData = new ArcadixFetchAndCacheData();
        var objInitialParams = DemoFtpFileDetails.InitialDataParams(this.props.JConfiguration, this.props);
    ...
    DemoFtpFileDetails.prototype.PageNumberClick = function (iStartPageNumber) {
        var _this = this;
        this.setState({ blnShowAnimation: true });
        var objParams = {
    ...
    DemoFtpFileDetails.prototype.UpdateFtpFolderPath = function (objEvent) {
        this.strFilePath = objEvent.target.value;
        this.iFrom = 1;
        this.PageNumberClick(1);
    };
    DemoFtpFileDetails.prototype.GetColumns = function () {
        return [
            {
                "ValidationId": "1",
                "Data": "Name",
    ...
    DemoFtpFileDetails.prototype.render = function () {
        var _this = this;
    ...
    return DemoFtpFileDetails;
}(React.Component));
export default withRouter(connect(mapStateToProps, {})(DemoFtpFileDetails));
//# sourceMappingURL=DemoFTPFileDisplay.js.map