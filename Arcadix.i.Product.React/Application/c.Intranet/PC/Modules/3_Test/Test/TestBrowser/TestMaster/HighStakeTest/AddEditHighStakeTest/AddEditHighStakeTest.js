...
import * as AddEditHighStakeTest_Hook from '@shared/Application/c.Intranet/Modules/3_Test/Test/TestBrowser/TestMaster/HighStakeTest/AddEditHighStakeTest/AddEditHighStakeTest_Hook';
import AddEditHighStakeTest_ModuleProcessor from '@shared/Application/c.Intranet/Modules/3_Test/Test/TestBrowser/TestMaster/HighStakeTest/AddEditHighStakeTest/AddEditHighStakeTest_ModuleProcessor';
...
/**
* @name AddEditHighStakeTest.
* @param {object} props props.
* @summary This component is used to Add/Edit the AddEditHighStakeTest data.
* @returns {object} React.Fragement that contains the content to be added in popup required for add/edit.
*/
const AddEditHighStakeTest = (props) => {
   ...
   */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditHighStakeTest_Hook.GetInitialState());
    ...
    */
    let objContext = { state, props, dispatch, "AddEditHighStakeTest_ModuleProcessor": new AddEditHighStakeTest_ModuleProcessor() };
    ...
    * @returns null
    */
    AddEditHighStakeTest_Hook.Initialize(objContext);
        ...
        return <div className="addedit-test">
            <div id="General"
                ...
                <BasicProperty
                    ...
                    Events={{
                        OnKeyDown: (e) => objContext.AddEditHighStakeTest_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditHighStakeTest_ModuleProcessor, objContext)
                    }}
                    ParentProps={{ ...props }}
                />
...
export default AddEditHighStakeTest;