...
//Module related fies.
import * as AddEditSurveyListTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/SurveyListTask/AddEditSurveyListTask/AddEditSurveyListTask_Hook';
...
const AddEditSurveyListTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditSurveyListTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditSurveyListTask_ModuleProcessor": new AddEditSurveyListTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditSurveyListTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditSurveyListTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditSurveyListTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditSurveyListTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />                       
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditSurveyListTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditSurveyListTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditSurveyListTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
    ...
    const GetDevelopmentHistoryDiv = () => {
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditSurveyListTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    */
    ...
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
            ...
            CallBacks={{
                GetAuditUserName: (struUserId) => objContext.AddEditSurveyListTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
            }}
            ParentProps={{ ...props }}
        /> : <div />
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditSurveyListTask_ModuleProcessor.StoreMapList()))(AddEditSurveyListTask);