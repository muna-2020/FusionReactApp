...
//Module related fies.
import * as AddEditDemoTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/DemoTask/AddEditDemoTask/AddEditDemoTask_Hook';
import AddEditDemoTask_ModuleProcessor from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/DemoTask/AddEditDemoTask/AddEditDemoTask_ModuleProcessor';
...
const AddEditDemoTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditDemoTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditDemoTask_ModuleProcessor": new AddEditDemoTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditDemoTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditDemoTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditDemoTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditDemoTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />            
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditDemoTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditDemoTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditDemoTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
    ...
    */
    const GetDevelopmentHistoryDiv = () => {
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditDemoTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
                ...
                CallBacks={{
                    GetAuditUserName: (struUserId) => objContext.AddEditDemoTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
                    }}
                ParentProps={{ ...props }}
                /> : <div/> 
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditDemoTask_ModuleProcessor.StoreMapList()))(AddEditDemoTask);
