...
//Module related fies.
import * as AddEditHighStakeExampleTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/HighStakeExampleTask/AddEditHighStakeExampleTask/AddEditHighStakeExampleTask_Hook';
import AddEditHighStakeExampleTask_ModuleProcessor from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/HighStakeExampleTask/AddEditHighStakeExampleTask/AddEditHighStakeExampleTask_ModuleProcessor';
...
const AddEditHighStakeExampleTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditHighStakeExampleTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditHighStakeExampleTask_ModuleProcessor": new AddEditHighStakeExampleTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditHighStakeExampleTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditHighStakeExampleTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditHighStakeExampleTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditHighStakeExampleTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditHighStakeExampleTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditHighStakeExampleTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditHighStakeExampleTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
    ...
    const GetDevelopmentHistoryDiv = () => {
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditHighStakeExampleTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    */
    ...
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
            ...
            CallBacks={{
                GetAuditUserName: (struUserId) => objContext.AddEditHighStakeExampleTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
            }}
            ParentProps={{ ...props }}
        /> : <div />
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditHighStakeExampleTask_ModuleProcessor.StoreMapList()))(AddEditHighStakeExampleTask);