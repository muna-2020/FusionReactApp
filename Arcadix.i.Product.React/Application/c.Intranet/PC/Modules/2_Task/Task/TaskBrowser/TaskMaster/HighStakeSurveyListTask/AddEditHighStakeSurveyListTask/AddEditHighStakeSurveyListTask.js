...
//Module related fies.
import * as AddEditHighStakeSurveyListTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/HighStakeSurveyListTask/AddEditHighStakeSurveyListTask/AddEditHighStakeSurveyListTask_Hook';
...
const AddEditHighStakeSurveyListTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditHighStakeSurveyListTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditHighStakeSurveyListTask_ModuleProcessor": new AddEditHighStakeSurveyListTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditHighStakeSurveyListTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditHighStakeSurveyListTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditHighStakeSurveyListTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />            
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
    ...
    const GetDevelopmentHistoryDiv = () => {
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    */
    ...
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
            ...
            CallBacks={{
                GetAuditUserName: (struUserId) => objContext.AddEditHighStakeSurveyListTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
            }}
            ParentProps={{ ...props }}
        /> : <div />
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditHighStakeSurveyListTask_ModuleProcessor.StoreMapList()))(AddEditHighStakeSurveyListTask);