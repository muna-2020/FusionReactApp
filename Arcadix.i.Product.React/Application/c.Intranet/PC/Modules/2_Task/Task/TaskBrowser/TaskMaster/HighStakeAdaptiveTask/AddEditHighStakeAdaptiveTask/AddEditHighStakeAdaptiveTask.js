...
//Module related fies.
import * as AddEditHighStakeAdaptiveTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/HighStakeAdaptiveTask/AddEditHighStakeAdaptiveTask/AddEditHighStakeAdaptiveTask_Hook';
...
const AddEditHighStakeAdaptiveTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditHighStakeAdaptiveTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditHighStakeAdaptiveTask_ModuleProcessor": new AddEditHighStakeAdaptiveTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditHighStakeAdaptiveTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditHighStakeAdaptiveTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
    ...
    const GetDevelopmentHistoryDiv = () => {
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    */
    ...
    /**
* @name GetEmpiricalDataDiv
* @summary Forms the whole jsx required for the EmpiricalDataDiv.
* @returns {object} jsx, React.Fragment
*/
    const GetEmpiricalDataDiv = () => {
        return <div style={{ display: (state.strDivToShow == "EmpiricalDataDiv" ? "block" : "none") }}> Yet to be implemented </div>
    };
    ...
    */
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
            ...
            CallBacks={{
                GetAuditUserName: (struUserId) => objContext.AddEditHighStakeAdaptiveTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
            }}
            ParentProps={{ ...props }}
        /> : <div />
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditHighStakeAdaptiveTask_ModuleProcessor.StoreMapList()))(AddEditHighStakeAdaptiveTask);
