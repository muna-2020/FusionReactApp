...
//Module related fies.
import * as AddEditHighStakeSurveyTask_Hook from '@shared/Application/c.Intranet/Modules/2_Task/Task/TaskBrowser/TaskMaster/HighStakeSurveyTask/AddEditHighStakeSurveyTask/AddEditHighStakeSurveyTask_Hook';
...
const AddEditHighStakeSurveyTask = props => {
     ...
     */
    const [state, dispatch] = useReducer(IntranetBase_Hook.Reducer, AddEditHighStakeSurveyTask_Hook.GetInitialState(props));
     ...
     */
    let objContext = { state, props, dispatch, "AddEditHighStakeSurveyTask_ModuleProcessor": new AddEditHighStakeSurveyTask_ModuleProcessor() };

    /**
     * @name Initialize
     * @param {object} objContext context object
     * @summary Initialize method call in AddEditHighStakeSurveyTask_Hook, that contains all the custom hooks.
     * @returns null
     */
    AddEditHighStakeSurveyTask_Hook.Initialize(objContext);
    ...
    const GetTaskDiv = () => {
        return <div id="TaskDiv" style={{
            ...
            <BasicProperties
                ...
                Events={{
                    OnKeyDown: (e) => objContext.AddEditHighStakeSurveyTask_ModuleProcessor.HandleEnterKeyDown(e, objContext.AddEditHighStakeSurveyTask_ModuleProcessor, objContext)
                }}
                ParentProps={{ ...props }}
            />
            ...
            <Taxonomy
                ...
                Data={{
                    DisplayData: state.objData,
                    SubjectId: props.Data.IsEdit ? objContext.AddEditHighStakeSurveyTask_ModuleProcessor.GetSubjectId(state.objData["iSubjectId"], objContext) : -1,
                    DropdownData: {
                ...
                Events={{
                    IsTheDropDownToShow: (strKey) => objContext.AddEditHighStakeSurveyTask_ModuleProcessor.IsTheDropDownToShow(strKey, objContext),
            ...
            <Language
                ...
                Events={{
                    IsShowLanguageDiv: () => objContext.AddEditHighStakeSurveyTask_ModuleProcessor.IsShowLanguageDiv(objContext)
                }}
                Resource={{
                    Text: props.Resource.Text,
        ...
        return <div style={{ display: (state.strDivToShow == "DevelopmentHistoryDiv" ? "block" : "none") }} className="task-tabcontent">
            ...
            <WorkflowStatus
                ...
                Data={{
                    ...
                    IsEdit: props.Data.IsEdit,
                    //FullWorkflowStatuses: objContext.state.arrFullWorkflowStatuses
                }}
                Resource={{
                    Text: props.Resource.Text,
                    JConfiguration: props.JConfiguration,
                ...
                Events={{
                    GetAdministratorName: (strUserId) => objContext.AddEditHighStakeSurveyTask_ModuleProcessor.GetAdministratorName(strUserId, objContext)
                }}
                ParentProps={{ ...props }}
            />
        </div>
    ...
    */
    ...
    const GetAuditDiv = () => {
        return state.strDivToShow == "AuditDiv" ? <Audit
            ...
            CallBacks={{
                GetAuditUserName: (struUserId) => objContext.AddEditHighStakeSurveyTask_ModuleProcessor.GetAdministratorName(struUserId, objContext)
            }}
            ParentProps={{ ...props }}
        /> : <div />
    };
...
export default connect(IntranetBase_Hook.MapStoreToProps(AddEditHighStakeSurveyTask_ModuleProcessor.StoreMapList()))(AddEditHighStakeSurveyTask);