...
import LoginImage from '@inlineimage/Common/ReactJs/PC/Icons/log_in.png?inline';
...
const Login = props => {
    ...
    */
    let objContext = { state, props, dispatch, ["ModuleName"]: "Login", ["Login_ModuleProcessor"]: new Login_ModuleProcessor(), ["ImageMeta"]: GetImageMeta() };
