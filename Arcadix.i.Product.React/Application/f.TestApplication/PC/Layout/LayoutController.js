...
const Layout = {
    Standard: {
        ...
        StandardLoginLayout: function () {
            return loadable(() => import(/* webpackChunkName: "StandardLoginLayout" */ '@root/Application/f.TestApplication/PC/Layout/Standard/3_Login/StandardLoginLayout'));
        },
        StandardIntroductionLayout: function () {
            return loadable(() => import(/* webpackChunkName: "StandardIntroductionLayout" */ '@root/Application/f.TestApplication/PC/Layout/Standard/4_Introduction/StandardIntroductionLayout'));
        },
        StandardTaskLayout: function () {
            return loadable(() => import(/* webpackChunkName: "StandardTaskLayout" */ '@root/Application/f.TestApplication/PC/Layout/Standard/5_Task/StandardTaskLayout'));
        },
