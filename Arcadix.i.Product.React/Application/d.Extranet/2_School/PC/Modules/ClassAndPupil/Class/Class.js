    ...
    function GetContent() {
        ...
        return (
            <div className="panel-left">
                    ...
                    <div className="top-head">
                        {showTeacherDropDown === true ?
                            <React.Fragment>
                                ...
                                <div className="content-dropdown teacher-dropdown">
                        ...
                        <div className="content-dropdown teacher-status-dropdown">
                            <PerformanceProfiler ComponentName={"TeacherstatusToggleDropDown"} JConfiguration={props.JConfiguration} >
                                <WrapperComponent
                                    ComponentName={"Dropdown"}
                        ...
                        </div>
                        {
                            showClassAndTeamTeacherDropdown === true ?
                                <React.Fragment>
                                    <div className="content-dropdown class-and-team-dropdown">
                                        <PerformanceProfiler ComponentName={"ClassAndTeamTeacherDropdown"} JConfiguration={props.JConfiguration} >
                                            <WrapperComponent
                                                ComponentName={"Dropdown"}
                                                Id="ClassAndTeamTeacherDropdown"
                                                Meta={objContext.Class_ModuleProcessor.GetMetaDataStatusToggleDropDown(objContext)}
                                                Data={objClassAndTeamTeacherToggleDropdownData}
                                                Resource={objContext.Class_ModuleProcessor.GetResourceDataTeacherDropDown(objTextResource)}
                                                Events={objContext.Class_ModuleProcessor.GetEventsClassAndTeamTeacherStatusToggleDropDown(objContext)}
                                                ParentProps={{ ...props }}
                                            />
                                        </PerformanceProfiler>
                                    </div>
                ...
                <PerformanceProfiler ComponentName={"ClassGrid"} JConfiguration={props.JConfiguration} >
                    <Grid
                        Id="Class_Grid"
