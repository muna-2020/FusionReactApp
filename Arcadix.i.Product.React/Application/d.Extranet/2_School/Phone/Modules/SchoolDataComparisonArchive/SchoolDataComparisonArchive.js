...
const SchoolDataComparisonArchive = props => {
    ...
    */
    ...
    function GetContent() {
        ...
        return (
            <React.Fragment>
                <div className="data-comparison-archive">
                    <div className="data-comparison-archive-title">
                        <span>Leistungsvergleich Archiv</span>
                        <img
                    ...
                    <div className="data-comparison-archive-content-wrapper">
                        ...
                        <div className="data-comparison-archive-table-wrapper">
                            <table className="data-comparison-archive-table">
                                <tbody>
                    ...
                    <div className="data-comparison-archive-footer">
