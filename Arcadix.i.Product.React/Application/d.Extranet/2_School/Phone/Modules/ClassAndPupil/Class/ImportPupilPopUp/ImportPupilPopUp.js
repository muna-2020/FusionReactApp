...
//Module realted fies.
import * as ImportPupilPopUp_Hook from '@shared/Application/d.Extranet/2_School/Phone/Modules/ClassAndPupil/Class/ImportPupilPopUp/ImportPupilPopUp_Hook';
import ImportPupilPopUp_ModuleProcessor from "@shared/Application/d.Extranet/2_School/Phone/Modules/ClassAndPupil/Class/ImportPupilPopUp/ImportPupilPopUp_ModuleProcessor";
...
const ImportPupilPopUp = (props) => {
    ...
    */
    ...
    const ShowNextSlide = () => {
        SetclassContent("hideContent");
        SetNextSlideContent("");
    };

    const ShowPreviousSlide = () => {
        SetclassContent("");
        SetNextSlideContent("hideContent");
    };
                ...
                <div className="importdata-wrapper">
                    ...
                    <div className="import-data-all-content">
                        ...
                        <div className={state.classNextSlideContent}>
                            ...
                            <button className="close-popup back-direction-icons" onClick={(objEvt) => props.ClosePopup(props.ObjModal)} >Übernehmen</button>
                        </div>
