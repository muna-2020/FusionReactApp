...
//Module related fies.
import * as Pupil_Hook from '@shared/Application/d.Extranet/2_School/Phone/Modules/ClassAndPupil/Pupil/Pupil_Hook';
import Pupil_ModuleProcessor from "@shared/Application/d.Extranet/2_School/Phone/Modules/ClassAndPupil/Pupil/Pupil_ModuleProcessor";
            ...
            <div className="Lernende">
                ...
                <div className="top-head">
                    ...
                    <div className="header-right">
                        <button className="button yellow-button information-button" onClick={() => { props.UpdateInformationPopupStatus() }}>{props.ShowInformationBar ? Localization.TextFormatter(objTextResource, 'HideInformationBar') : Localization.TextFormatter(objTextResource, 'ShowInformationBar')}</button>
                    </div>
                </div>
                {props.ShowPuilGrid ? <Grid
                    Id="Pupil_Grid"
