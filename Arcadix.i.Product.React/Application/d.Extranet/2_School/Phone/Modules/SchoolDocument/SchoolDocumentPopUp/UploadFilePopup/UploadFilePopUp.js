...
import * as UploadFilePopup_Hook from '@shared/Application/d.Extranet/2_School/Phone/Modules/SchoolDocument/SchoolDocumentPopUp/UploadFilePopup/UploadFilePopup_Hook';
import UploadFilePopup_ModuleProcessor from '@shared/Application/d.Extranet/2_School/Phone/Modules/SchoolDocument/SchoolDocumentPopUp/UploadFilePopup/UploadFilePopup_ModuleProcessor';
            ...
            <div className="upload-file-popup-main">
                ...
                <div className="popup-buttons">
                    ...
                    {arrFileUploaded.length == 0 ?
                        <button className="yellow-button disabled">{Localization.TextFormatter(objTextResource, 'Upload')}</button>
                        : <button className="yellow-button" onClick={OnClickSave}>{Localization.TextFormatter(objTextResource, 'Upload')}</button>
                    }
                </div>
            </div>
