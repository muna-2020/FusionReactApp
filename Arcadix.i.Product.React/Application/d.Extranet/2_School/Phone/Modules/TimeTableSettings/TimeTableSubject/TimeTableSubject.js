...
import * as TimeTableSubject_Hook from '@shared/Application/d.Extranet/2_School/Phone/Modules/TimeTableSettings/TimeTableSubject/TimeTableSubject_Hook';
import TimeTableSubject_ModuleProcessor from '@shared/Application/d.Extranet/2_School/Phone/Modules/TimeTableSettings/TimeTableSubject/TimeTableSubject_ModuleProcessor';
            ...
            <React.Fragment>
                <div className={'subject-table-section'}>
                    <div className="subject-table-heading">
                        <span>{Localization.TextFormatter(objTextResource, 'SubjectNameText')}</span>
                        <span>{Localization.TextFormatter(objTextResource, 'SubjectAbbreviationText')}</span>
                    </div>

                    <div className="control-buttons">
                        <div className="control-buttons-left">
                            <button onClick={(event) => { objContext.TimeTableSubject_ModuleProcessor.HandleAddRow(objContext); }}>
                                <img
                                    src={imgPlus}
                        ...
                        <div className="control-buttons-right">
                            <button className="button-white" onClick={(event) => { objContext.TimeTableSubject_ModuleProcessor.HandleReset(objContext); }}>
