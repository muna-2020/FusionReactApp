...
import * as Notes_Hook from '@shared/Application/d.Extranet/3_Teacher/PC/Modules/Notes/Notes_Hook';
import * as Notes_ModuleProcessor from '@shared/Application/d.Extranet/3_Teacher/PC/Modules/Notes/Notes_ModuleProcessor';
...
const Notes = (props) => {
    ...
    */
    ...
    function GetContent() {
        let arrOrders = [1, 2, 3];
        let objTextResource = Object_Framework_Services_TextResource.GetData("/d.Extranet/3_Teacher/Modules/Notes", props);
