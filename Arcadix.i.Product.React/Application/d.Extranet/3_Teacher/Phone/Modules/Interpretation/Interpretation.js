...
//Module related fies.
import * as Interpretation_Hook from '@shared/Application/d.Extranet/3_Teacher/Phone/Modules/Interpretation/Interpretation_Hook';
import Interpretation_ModuleProcessor from "@shared/Application/d.Extranet/3_Teacher/Phone/Modules/Interpretation/Interpretation_ModuleProcessor";
    ...
    function GetContent() {
        ...
        return (
            ...
            <div className="interpretation-title">
                <div className="interpretation-title-left">
                    <span className="heading-left">Orientierungstest</span>
                    <img
                        src={require("../../../../../../../Arcadix.h.Product.Resources/Themes/Default_2020/d.Extranet/Skin2018/Images/Common/Icons/angle-right-blue.svg")}
                    />
                    <span className="menu-title">Interpretation</span>
                </div>
                <div className="interpretation-title-right">
                    <img
            ...
            {/*interpretation wrapper starts here*/}

            <div className="interpretation-main-wrapper">

                {/*chart section starts here*/}
                <div className="interpretation-chart-section">
                    <span className="chart-heading">{Localization.TextFormatter(objTextResource, 'SubSubject')}:</span>
                    {/* <img
                        src={require("../../../../../../../Arcadix.h.Product.Resources/Themes/Default_2020/d.Extranet/Skin2018/Images/Common/Icons/barChartTest.svg")}
                    /> */}
                    <React.Fragment>
                ...
                <WrapperComponent
                    ...
                    <div className="interpretation-accordian-wrapper">
                        {GetDetailedElements()}
                    </div>
                </WrapperComponent>
            </div>
                                ...
                                return (
                                    <React.Fragment>
                                        <div className="accordian" >
                                            <div className="accordian-header" ref={accordionHeaderRef} 
                                                onClick={() => {
                                            ...
                                            >
                                                <span className="accordian-header-text">Kompetenzniveau {objThreshold.t_testDrive_Subject_FeedbackThreshold_Data.find(obj => obj.iLanguageId == strLanguageId).vThresholdHeading}</span>
                                                <img
                                                    src={state.blnOpenIndex.includes(index) ? AngleUpImage : AngleDownImage}
                                                />
                                            </div>
                                            <div id={"accordionContent" + index.toString()} ref={refCurrentAccordionContent} >
                                                ...
                                                arrFilteredTopic
                                                    ...
                                                    .map(objTopic => {
                                                        return (
                                                            <div className={"accordian-content show"}
                                                            >
                                                                <span className="accordian-content-heading">{objTopic.t_testDrive_Subject_FeedbackThreshold_Topic_Data.find(objTopicData => objTopicData["iLanguageId"] == strLanguageId)["vFeedbackThresholdTopic"]}</span>
                                                                {
                                                                    arrFilteredTopicDescription.map(objDescription => {
                                                                        if (objTopic["uFeedbackThresholdTopicId"] == objDescription["uFeedbackThresholdTopicId"]) {
                                                                            ...
                                                                            return (
                                                                                <React.Fragment>
                                                                                    {objDescription["iPageId"] != null && objPageJsonForDescription && <div className="editor-area">
                                                                                        <TaskContentPreview PageJson={objPageJsonForDescription} JConfiguration={{ ...JConfiguration }} />
                                                                                    </div>}
                                                                                    {
                                                                                        objDescription.t_TestDrive_Subject_FeedbackThreshold_Description_Tasks.map(objTask => {
                                                                                            ...
                                                                                            return (
                                                                                                <React.Fragment>
                                                                                                    <span className="accordian-content-sub-heading">{objTask["vTaskName"]}</span>
