...
//Module related fies.
import * as Contact_Hook from '@shared/Application/d.Extranet/5_Shared/Phone/Modules/Contact/Contact_Hook';
import Contact_ModuleProcessor from "@shared/Application/d.Extranet/5_Shared/Phone/Modules/Contact/Contact_ModuleProcessor";
                ...
                <div className="contact-main-wrapper">
                    {!state.blnShowMailSentDiv ?
                        <div className="contact-main">
                            ...
                            <div className="contact-block" dangerouslySetInnerHTML={ClientContactDetailsdiv} />
                            <div className="contact-block">
                                <p>{strEmailSentTitle}</p>
                                <div className="contact-form">
                                    <div className="choose-file-main">
                                        <FileUpload
                                ...
                                <div className="form-text">
                                    ...
                                    <button className="brown-button" onClick={() => EmailSend(objContext, objResourceData)}>{Localization.TextFormatter(objResourceData, 'SendButton')}</button>
                                </div>
                            </div>
                        </div>
                        :
