...
import CMSContainer from '@root/Application/e.Editor/PC/Modules/5_CMSContainer/CMSContainer_Editor/CMSContainer_Editor_Wrapper';
...
const CMSPageContent_Editor = (props, ref) => {
    ...
    const GetContainerContent = (objContainerJson) => {
        let ContainerTemplate, ComponentController;
