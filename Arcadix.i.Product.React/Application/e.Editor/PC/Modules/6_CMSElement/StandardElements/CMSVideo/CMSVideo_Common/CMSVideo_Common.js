    ...
    const GetContent = () => {
        ...
        return (
            <div ref={Context.VideoPlayerRef}
                ...
                style={{ "width": `${Context.state.objVideoControl.iWidth}px`, "min-height": `${Context.state.objVideoControl.iHeight}px`, position: "relative", display: "inline-block" }}>
                {
                ...
                {!Context.state.objVideoControl.boolMediaLoaded &&
