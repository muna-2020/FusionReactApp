...
import Icon_CloseImage from '@inlineimage/Common/ReactJs/PC/Icons/Icon_Close.svg';
...
export function mapStateToProps(state) {
    return {
        Sidebar: state.ApplicationState["LeftSidebar"]
    };
}
...
const LeftSidebar = (props) => {
     ...
     */
    useEffect(() => {
        ApplicationState.SetProperty("showLeftSidebar", ShowSidebar);
        ApplicationState.SetProperty("hideLeftSidebar", HideSidebar);
    }, []);
    ...
    const ShowSidebar = (objSidebar) => {
        ...
        UpdateSidebarStatusToEditor("left", true);
        ApplicationState.SetProperty("LeftSidebar", { ...objSidebar });
    };
    ...
    const HideSidebar = (fnCallback) => {
        let objSidebar = ApplicationState.GetProperty("LeftSidebar");
        ...
        UpdateSidebarStatusToEditor("left", false)
        if (objSidebar) {
            ApplicationState.SetProperty("LeftSidebar", {});
        }
    };
            ...
            return (
                <React.Fragment>
                    <div ref={SidebarComponent_Ref} style={{ display: "block", height: "100%" }}>
                        {/*<SidebarComponent {...objSidebarProps} />*/}
                        <ComponentLoader
                            {...objSidebarProps}
    ...
    const GetContent = () => {
        ...
        return (
            props.Sidebar ?
                <div className={"sidebar left-sidebar"} style={{ display: props.Sidebar && props.Sidebar.SidebarProps && props.Sidebar.SidebarProps.Status === 1 ? "block" : "none" }}>
