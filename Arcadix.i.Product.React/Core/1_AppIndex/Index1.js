...
import Object_Framework_Services_DynamicStyle from '@shared/Object/a.Framework/Services/DynamicStyle/DynamicStyle';
...
global.Object_Framework_Services_DynamicStyle = Object_Framework_Services_DynamicStyle;
...
if (process.env.NODE_ENV === "development" && JConfiguration["IsDevelopment"] !== false) {
    ...
    update = () => {
       ...
       debounce(RefreshRuntime.performReactRefresh, 100);
    }
}
