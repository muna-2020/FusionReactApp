...
const ClientSideConfiguration = {
    ...
    output: {
        path: res('../../../../Arcadix.i.Product.React.Bundle/Development/Application/f.TestApplication/PC/ClientBuild'),
        filename: '[name].js',
        chunkFilename: "[name].chunk.js",
        publicPath: '/Bundle/Application/f.TestApplication/PC/ClientBuild/',
    ...
    resolve: {
        ...
        alias: {
            ...
            '@appfolder': path.join(__dirname, '../../../Application/f.TestApplication/PC'),
...
const ServerSideConfiguration = {
    ...
    output: {
        path: res('../../../../Arcadix.i.Product.React.Bundle/Development/Application/f.TestApplication/PC/ServerBuild'),
        filename: '[name].js',
        chunkFilename: "[name].chunk.js",
        publicPath: '/Bundle/Application/f.TestApplication/PC/ClientBuild/',
        libraryTarget: 'commonjs2'
...
module.exports = [ClientSideConfiguration,ServerSideConfiguration]
