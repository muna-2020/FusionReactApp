...
import MutliSelectDropdown_Disabled_Sample_ModuleProcessor from '@shared/SupportApplication/Demo/Modules/Framework/Controls/Dropdowns/MultiSelectDropdown_Sample/MultiSelectDropdown_Disabled_Sample/MutliSelectDropdown_Disabled_Sample_ModuleProcessor';
import * as MultiSelectDropdown_Disabled_Sample_Hook from '@shared/SupportApplication/Demo/Modules/Framework/Controls/Dropdowns/MultiSelectDropdown_Sample/MultiSelectDropdown_Disabled_Sample/MultiSelectDropdown_Disabled_Sample_Hook';
import * as MultiSelectDropdown_Disabled_Sample_MetaData from '@shared/SupportApplication/Demo/Modules/Framework/Controls/Dropdowns/MultiSelectDropdown_Sample/MultiSelectDropdown_Disabled_Sample/MultiSelectDropdown_Disabled_Sample_MetaData';
        ...
        return (
            <React.Fragment>
                ...
                <MultiSelectDropdown
                    ...
                    Events={objContext.MultiSelectDropDown_Disabled_Sample_ModuleProcessor.GetEvents()}
                    CallBacks={objContext.MultiSelectDropDown_Disabled_Sample_ModuleProcessor.GetCallbacks()}
                    ParentProps={{ ...props }}
                />
            </React.Fragment>
            ); 
